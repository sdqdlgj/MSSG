...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file_list', type=str, dest='input_file_list', default='/share/home/liguanjun/src/LGJ_PretrainASD/predata/face_process/split/train_file_list.1', help="input_file_list")
