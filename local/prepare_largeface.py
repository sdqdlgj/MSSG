        ...
        for file_path in fid:
            ...
            for entity in entityList:
                ...
                for _, row in insData.iterrows():
                    ...
                    new_x1 = x1 - 0.25*(x2-x1)
                    new_x2 = x2 + 0.25*(x2-x1)
                    if new_x1 < 0:
                        new_x1 = 0
                    if new_x2 > 1:
                        new_x2 = 1
                    new_y1 = y1 - 0.25*(y2-y1)
                    new_y2 = y2 + 0.25*(y2-y1)
                    if new_y1 < 0:
                        new_y1 = 0
                    if new_y2 > 1:
                        new_y2 = 1
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file_list', type=str, dest='input_file_list', default='/share/home/liguanjun/src/LGJ_PretrainASD/predata/face_process/split/train_file_list.6', help="input_file_list")
